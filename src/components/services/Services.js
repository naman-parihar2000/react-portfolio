          ...
          >
            <div className="services__modal-content">
              <i
                ...
                onClick={() => toggleTab(0)}
              ></i>
              <h3 className="services__modal-title">My Potential</h3>
              <p className="services__modal-description">
                0.4 years of experience in web development providing quality
                work.
              </p>
        ...
        <div className="services__content">
          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                0.4 years of experience in Website Development providing quality
                work.
              </p>
              <ul className="services__modal-services grid">
                <li className="services__modal-service">
